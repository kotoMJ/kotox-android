...
sealed class MainScreenEvent {
    object OpenCountriesOverview : MainScreenEvent()
}
...
//                    }
                    ...
                    Row(
                        ...
                        OutlinedButton(
                            ...
                            onClick = {
                                onEventHandler.invoke(MainScreenEvent.OpenCountriesOverview)
                            }) {

                            Icon(
                                painter = painterResource(id = R.drawable.ic_countries),
                                contentDescription = null,
                                //tint = LocalColors.current.divider
                            )
                            Text(
                                text = stringResource(id = R.string.main_screen_action_countries),
